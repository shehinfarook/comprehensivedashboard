  ...
  return (
    <Box minHeight="100vh" display="flex" alignItems="stretch" bgcolor="#faf7fc">
      ...
      <Box flex={1} display="flex" flexDirection="column" justifyContent="center" alignItems="center" px={6} py={8} bgcolor="#fff">
        <Typography variant="h4" fontWeight={700} mb={2} color="#8e6be6">Admin Login</Typography>
        <form onSubmit={handleLogin} style={{ width: '100%', maxWidth: 360 }}>
          ...
          <Button type="submit" variant="contained" fullWidth sx={{ bgcolor: '#8e6be6', color: '#fff', fontWeight: 600, py: 1.5, fontSize: 16, borderRadius: 2, boxShadow: 2, mt: 2 }}>Login</Button>
